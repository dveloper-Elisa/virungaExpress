...
<FORM ACTION="ereport.php" METHOD="post">
<BR><BR><CENTER><U><FONT COLOR="#3090C7" SIZE="2" FACE="COMIC SANS MS">REPORT BY CASHBOX</U></FONT>
<div id="logini"><BR><BR>
<CENTER><TABLE><TR>
<TD WIDTH="50%">Select Cashbox&nbsp;&nbsp;</TD><TD>:&nbsp;&nbsp;<SELECT NAME="loc1" style="width:4em">
...
<OPTION VALUE='' SELECTED>");
$deso=mysqli_query($conn,"SELECT Source FROM destination GROUP BY Source ORDER BY Source ASC");
while($reso=mysqli_fetch_assoc($deso))
  {
	  $loc=$reso['Source'];
	  print("<OPTION VALUE=$loc>$loc");
  }
...
<TR><TD>From Date</TD><TD><?php $Date=date("Y-m-d");
print(":&nbsp;&nbsp;<INPUT TYPE=text SIZE=17 NAME=dat1 id='SelectedDate' onClick='GetDate(this)' STYLE='border-color:#45E01F' VALUE='$Date'></TD></TR> 
<TR><TD>To Date</TD><TD>:&nbsp;&nbsp;<INPUT TYPE=text SIZE=17 NAME=dat2 id='SelectedDate' onClick='GetDate(this)' STYLE='border-color:#45E01F' VALUE='$Date'>");
?></TD></TR></TABLE><BR>
<HR WIDTH="90%">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<INPUT TYPE="submit" NAME="view" VALUE="&nbsp;&nbsp;&nbsp;&nbsp;VIEW&nbsp;&nbsp;&nbsp;&nbsp;">&nbsp;&nbsp;<INPUT TYPE="reset" VALUE="CANCEL">
