...
<FORM ACTION="lreport.php" METHOD="post">
<BR><BR><CENTER><U><FONT COLOR="#3090C7" SIZE="2" FACE="COMIC SANS MS">CAR'S REPORT</U></FONT>

<div id="logini"><BR><BR>
<CENTER><TABLE><TR>
<TD>Select a car&nbsp;&nbsp;</TD><TD>:&nbsp;&nbsp;<SELECT NAME="car">
<OPTION VALUE="" SELECTED> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

	<?php
include'connect.php';
$des=mysqli_query($conn,"SELECT * FROM cars ORDER BY Carid ASC");
...
print(":&nbsp;&nbsp;<INPUT TYPE=text SIZE=15 NAME=dat1 id='SelectedDate' onClick='GetDate(this)' STYLE='border-color:#45E01F' VALUE='$Date'></TD></TR> 
<TR><TD>To Date</TD><TD>:&nbsp;&nbsp;<INPUT TYPE=text SIZE=15 NAME=dat2 id='SelectedDate' onClick='GetDate(this)' STYLE='border-color:#45E01F' VALUE='$Date'>");
?></TD></TR></TABLE><BR>
<HR WIDTH="90%">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
