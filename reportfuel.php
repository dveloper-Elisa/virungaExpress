...
<div id="contents">
<FORM ACTION="repofuel.php" METHOD="post">
<BR><BR><CENTER><U><FONT COLOR="#3090C7" SIZE="2" FACE="COMIC SANS MS">FUEL REPORT</U></FONT>

<div><BR><BR>
<CENTER><TABLE><TR>
<TD WIDTH="40%">Plaque &nbsp;&nbsp;</TD><TD>:&nbsp;&nbsp;<SELECT NAME="plate">
...
while($res=mysqli_fetch_assoc($des))
  {
	  $pl=$res['Carid'];
	  print("<OPTION VALUE='$pl'>&nbsp;&nbsp;&nbsp;&nbsp;$pl</option>");
  }
...
<TR><TD>Engine</TD><TD>:&nbsp;&nbsp;<SELECT NAME=engine>
<OPTION VALUE='ALL' SELECTED>&nbsp;&nbsp;&nbsp;&nbsp;ALL</option>");
$dos=mysqli_query($conn,"SELECT Engine FROM cars GROUP BY Engine ORDER BY Engine DESC");
...
<TR><TD>Date</TD><TD><?php $Date=date("Y-m-d");
print(":&nbsp;&nbsp;<INPUT TYPE=text SIZE=8 NAME=dat1 id='SelectedDate' onClick='GetDate(this)' STYLE='border-color:#45E01F' VALUE='$Date'> - <INPUT TYPE=text SIZE=8 NAME=dat2 id='SelectedDate' onClick='GetDate(this)' STYLE='border-color:#45E01F' VALUE='$Date'>");
?></TD></TR></TABLE><BR>
<HR WIDTH="90%"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<INPUT TYPE="submit" NAME="dateranger" VALUE="&nbsp;&nbsp;&nbsp;&nbsp;Range view&nbsp;&nbsp;&nbsp;&nbsp;">&nbsp;&nbsp;<INPUT TYPE="submit" NAME="view" VALUE="&nbsp;&nbsp;&nbsp;&nbsp;VIEW&nbsp;&nbsp;&nbsp;&nbsp;">&nbsp;&nbsp;<INPUT TYPE="reset" VALUE="CANCEL">
</DIV><BR><BR><BR><BR></CENTER>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<FONT COLOR="#0099FF"><B></B>Other Links</FONT><HR WIDTH="88%" style="border : none;
border-top : dashed 1px #54C571;
color : #FFFFFF;
background-color : #FFFFFF;
height : 1px;">
<CENTER><TABLE WIDTH="80%" class="tableMenu">
<TR>
	<TD><A HREF="creport.php" class="MyLink">Cashbox's Report</A></TD>
	<TD><A HREF="careport.php" class="MyLink">Car's Report</A></TD>
	<TD><A HREF="transaction.php" class="MyLink">Transactions</A></TD>
</TR>
<TR>
	<TD><A HREF="report.php" class="MyLink">Report I</A></TD>
	<TD><A HREF="cars.php" class="MyLink">Cars' Location</A></TD>
	<TD><A HREF="report.php" class="MyLink">Report III</A></TD>
</TR>
<TR>
	<TD><A HREF="report.php" class="MyLink">Report IV</TD>
	<TD><A HREF="report.php" class="MyLink">Report V</TD>
	<TD><A HREF="report.php" class="MyLink">Report VI</TD>
</TR>
</TABLE>
</div>
</div>
