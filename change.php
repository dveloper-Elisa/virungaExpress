...
<div id="contents">
<FORM ACTION="change.php" onsubmit="return checkforme(this);" METHOD="Post">
...
<?php
 if(isset($_POST['search']))
  ...
  include'connect.php';
  $nql=mysqli_query($conn,"SELECT * FROM store WHERE DDate='$dat1' AND Location='$nloc' ORDER BY Item ASC");
  $cout=mysqli_num_rows($nql);
  if($cout)
		{
  print("<CENTER><U><FONT COLOR=#3090C7 SIZE=2 FACE=COMIC SANS MS>STOCK TRANSACTIONS ON $dat1 </U>(<B><U>$nloc</U></B>)</FONT><BR>
  <BR><TABLE WIDTH=98%><TR>
  <TH></TH><TH>SPARE PART</TH><TH>SPECIFICATION</TH><TH>QTY</TH><TH>PRICE</TH><TH>CONSUMER</TH><TH>DOCUMENT</TH><TH>OPERATOR</TH></TR>
  ...
  if($n%2==0)
    ...
    print("<TR BGCOLOR=#F2F2F2 onMouseover=this.bgColor='#EEE1E1' onMouseout=this.bgColor='#F2F2F2'>
          <FORM ACTION=tchange.php METHOD=post><TD WIDTH=5%>
	<INPUT TYPE=hidden NAME=hide VALUE=$N7><button form=delete name=delete>Delete</button>
	</TD><TD>&nbsp;&nbsp;$N2</TD><TD>&nbsp;&nbsp;$N3</TD><TD>&nbsp;&nbsp;$N5</TD><TD>&nbsp;&nbsp;$N120</TD>
	<TD><CENTER>$N6</TD><TD>&nbsp;&nbsp;$N9</TD><TD>&nbsp;&nbsp;$N11</TD></FORM></TR>");
	 }
	 else
	  {
  ...
  print("</TABLE></div>");
		...
		{
			print("<BR><BR><BR><BR><BR><BR><FONT COLOR=#FF0000>No result to be displayed ...</FONT>");
		}
		}
  ?>
