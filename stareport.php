...
<BR><BR><CENTER><U><FONT COLOR="#3090C7" SIZE="2" FACE="COMIC SANS MS">REPORT BY LOCATION</U></FONT>
<BR><BR><TABLE WIDTH="35%"><TR>
<TD WIDTH="50%">Select Location</TD><TD>:&nbsp;&nbsp;<SELECT NAME="loc">
<OPTION VALUE="" SELECTED>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php
include'connect.php';
$des=mysqli_query($conn,"SELECT Location FROM location ORDER BY Location ASC");
...
?></TD></TR></TABLE><BR>
<HR WIDTH="38%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<INPUT TYPE="submit" NAME="sview" VALUE="&nbsp;&nbsp;&nbsp;&nbsp;VIEW&nbsp;&nbsp;&nbsp;&nbsp;">&nbsp;&nbsp;<INPUT TYPE="reset" VALUE="CANCEL">
...
<TR>
	<TD><A HREF="creport.php" class="MyLink">Report by Cashbox</A></TD>
	<TD><A HREF="report.php" class="MyLink">Report by Vehicule</A></TD>
	<TD><A HREF="transaction.php" class="MyLink">Transactions</A></TD>
</TR>
<TR>
	<TD><A HREF="report.php" class="MyLink">Report I</A></TD>
	<TD><A HREF="report.php" class="MyLink">Report II</A></TD>
